...
var tracery = (function() {
    ...
    RuleSet.prototype.selectRule = function(errors) {
        ...
        if (this.defaultRules !== undefined) {
            ...
            switch (distribution) {
                ...
                default:
                    index = Math.floor(
                        Math.pow(rng.next, this.falloff) *
    ...
    // by default, RNG seed is Math.random()
    let rng = {
        next: Math.random()
    };
    ...
    var baseEngModifiers = {
        replace: function(s, params) {
            ...
            return s.replace(
                new RegExp(escapeRegExp(params[0]), 'g'),
                params[1]
            );
        },
        ...
        firstS: function(s) {
            ...
            var finished =
                baseEngModifiers.s(s2[0]) + ' ' + s2.slice(1).join(' ');
